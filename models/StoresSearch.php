...
class StoresSearch extends Stores
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['storeName', 'phoneFormatted', 'address', 'city', 'country', 'postalCode', 'latitude', 'longitude', 'email', 'cobertura','ejecutivo'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'storeName', $this->storeName])
            ->andFilterWhere(['like', 'phoneFormatted', $this->phoneFormatted])
            ...
            ->andFilterWhere(['like', 'ejecutivo', $this->ejecutivo]);
