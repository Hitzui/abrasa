...
var apiToken = "pk.eyJ1IjoiaGl0enVpIiwiYSI6ImNrcXNsaWNxejJvc2Yyb212bWZxOXU0aHoifQ.7fNFS-ZSsJX83Cfp9uRe9Q";
var defaultMap = [-85.904303857672, 12.940756356285643];
...
function getStores() {
    var jsonData = $.ajax({
        //recuerda cambiarlo cuando este en produccion
        url: 'https://abrasa.com.ni/producto/store',
        dataType: 'json',
        async: false
    }).responseText;
